...
/***/ function(module, exports, __webpack_require__) {
	...
	var _split = __webpack_require__(1);
	...
	window.onload = function () {
	    ...
	    (0, _split2.default)(['#container-panel-left', '#container-panel-right'], {
	        sizes: [30, 70],
	        minSize: [200, 200],
	        gutterSize: 10,
	    ...
	    (0, _split2.default)(['#container-panel-right-host-tab-top', '#container-panel-right-host-tab-bottom'], {
	        sizes: [30, 70],
	        minSize: [50, 50],
	        gutterSize: 10,
	        direction: 'vertical',
